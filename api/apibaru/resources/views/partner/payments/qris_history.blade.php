...
@section('content')
    ...
    <div class="panel panel-inverse">
        ...
        <div class="panel-body">
            <form method="GET" action="{{ route('partner.qris.history') }}" class="mb-3">
                <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                    ...
                    <div class="ms-auto">
                        ...
                        <a href="{{ route('partner.qris.history') }}" class="btn btn-default btn-sm"><i
                        ...
                        @forelse ($paginatedTransactions as $item)
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <strong>{{ $item->transactionable->owner->brand_name ?? '-' }}</strong><br>
                                    <small class="text-muted">
                                        Outlet: {{ $item->transactionable->outlet->outlet_name ?? 'N/A' }}
                                    </small>
                                </td>
