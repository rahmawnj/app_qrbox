...
@section('content')
    ...
    <div class="row">
        ...
        {{-- Card 4: Transaksi dengan Perangkat Belum Aktif --}}
        <div class="col-md-3">
            <div class="widget widget-stats bg-red mb-10px">
                ...
                <div class="stats-content">
                    ...
                    <div class="stats-number">{{ $totalTransactionsWithDeactivatedDevices }}</div>
                    <div class="stats-desc">Transaksi dengan perangkat yang statusnya 'false'.</div>
                </div>
            </div>
        </div>
    </div>
...
<form method="GET" action="{{ route('partner.transactions.drop-off.member') }}" class="mb-3">
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
        <div>
            ...
            <a href="{{ route('partner.transactions.drop-off.member') }}" class="btn btn-default btn-sm me-2">
