@props([
    'items' => ['Partner', 'Transaksi', 'Transaksi Self Service Non-Member'],
...
@section('content')
    ...
    <div class="panel panel-inverse">
        ...
        <div class="panel-body">
            <form method="GET" action="{{ route('partner.transactions.self-service.non-member') }}" class="mb-3">
                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                    <div>
                        ...
                        <a href="{{ route('partner.transactions.self-service.non-member') }}" class="btn btn-default btn-sm me-2">
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        @forelse ($transactions as $selfServiceTransaction)
                            @php
                                $transaction = $selfServiceTransaction->transaction;
                                ...
                                $deviceCodes = $transaction->deviceTransactions->pluck('device.code')->filter()->implode(', ');
                                if (empty($deviceCodes)) {
                                    $deviceCodes = $transaction->deviceTransactions->pluck('device_code')->filter()->implode(', ');
                                }
                            ...
                            <tr>
                                ...
                                <td><span class="badge {{ $statusBadgeClass }}">{{ ucfirst($transaction->status) ?? 'N/A' }}</span></td>
                                <td>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <dl class="row">
                                                        ...
                                                        <dd class="col-sm-8">Rp {{ number_format($payment->amount ?? 0, 0) }}</dd>
...
<th>Waktu Aktivasi Bypass</th>
<th>Waktu Aktivasi Final</th>
</tr>
</thead>
<tbody>
...
<td>
{{-- Status 1 = Belum Dijalankan, Status 0 = Dijalankan --}}
