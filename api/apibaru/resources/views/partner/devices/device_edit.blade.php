...
@section('content')
    ...
    <form action="{{ route('partner.device.update', $device->id) }}" method="POST" id="deviceForm">
        @csrf
        @method('PATCH')
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="code" value="{{ old('code', $device->code) }}" readonly>
