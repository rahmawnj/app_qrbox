...
Route::get('api-docs', function () { return view('api_docs'); })->name('api.docs');
Route::get('owner-guide', function () { return view('owner_guide'); })->name('owner.guide');

Route::get('dashboard', function () {
    if (auth()->guard('admin_config')->check()) return redirect()->route('admin.dashboard');
    if (auth()->guard('web')->check()) return redirect()->route('partner.dashboard');
...
Route::post('outlets/{id}/regenerate-token', [OutletController::class, 'regenerateToken'])->name('outlets.regenerate-token');
Route::get('database/migrate', [DatabaseMaintenanceController::class, 'migrate'])->name('database.migrate');
Route::get('database/migrate-fresh', [DatabaseMaintenanceController::class, 'migrateFresh'])->name('database.migrate-fresh');
Route::get('database/migrate-fresh-seed', [DatabaseMaintenanceController::class, 'migrateFreshSeed'])->name('database.migrate-fresh-seed');
Route::get('/clear-config', function () {
    Artisan::call('config:clear'); Artisan::call('config:cache'); Artisan::call('cache:clear'); Artisan::call('route:clear'); Artisan::call('view:clear');
...
Route::prefix('admin')->name('admin.')->middleware('auth:admin_config')->group(function () {
    Route::get('/api-docs', function () { return view('api_docs'); });
...
Route::prefix('partner')->name('partner.')->middleware('auth:web')->group(function () {
    ...
    Route::post('outlets', [PartnerOutletController::class, 'store'])->name('outlets.store');
    ...
    Route::patch('outlets/{outlet}', [PartnerOutletController::class, 'update'])->name('outlets.patch_update');
